...
<!--菜单 -->
	...
	<div class=tip>
		<div id="sidebar">
			<div id="wrap">
					...
					<div class="ibar_login_box status_login ">
						<div class="avatar_box ">
							...
							<ul class="user_info ">
								...
								<li>${sessionScope.user.level_name}</li>
							</ul>
				...
				<div id="shopCart " class="item " onclick="shopcar(${sessionScope.user.id})">
					<a onclick="javascript:shopcar(${sessionScope.user.id})"> <span class="message "></span>
					</a>
					<p>购物车</p>
					<p class="cart_num ">${sessionScope.count.c}</p>
				</div>
	...
	<div class=tip>
		<div id="sidebar">
			<div id="wrap">
				<div id="prof" class="item ">
					...
					<div class="ibar_login_box status_login ">
						<div class="avatar_box ">
							...
							<ul class="user_info " >
								<li><a href="../home/login.jsp" style="width: 150px;">请先登录</a></li>
								<li></li>
							</ul>
				...
				<div id="shopCart " class="item " onclick="noshopcar()">
					<a onclick="javascript:noshopcar()"> <span class="message "></span>
					</a>
					<p>购物车</p>
	...
	<script>
	   function shopcar(user_id) {
		location.href="../home/shopcarpay?user_id="+user_id;
	}
	   function noshopcar() {
		   location.href="../home/failedadd";
	}
